...
//    @Test
//    fun wrongEmailAndPasswordTest(){
//        onView(withId(R.id.logo)).check(matches((isDisplayed())))
//        onView(withId(R.id.getStartedButton)).perform(click())
//        onView(withId(R.id.input_email)).perform(typeText("Wrongemail@com"))
//        onView(withId(R.id.input_email)).perform(pressImeActionButton())
//        onView(withId(R.id.input_password)).perform(typeText("Wrongpassword"))
//        onView(withId(R.id.input_password)).perform(pressImeActionButton())
//        onView(withId(R.id.loginButton)).perform(click()).perform(closeSoftKeyboard())
//        onView(withText("Opps! Something went wrong"))
//                .inRoot(isDialog()) // <---
//                .check(matches(isDisplayed()))
//    }
//
//    @Test
//    fun correctEmailAndPasswordTest(){
//        onView(withId(R.id.logo)).check(matches((isDisplayed())))
//        onView(withId(R.id.getStartedButton)).perform(click())
//        onView(withId(R.id.input_email)).perform(typeText("harrisonwjy@hotmail.com"))
//        onView(withId(R.id.input_email)).perform(pressImeActionButton())
//        onView(withId(R.id.input_password)).perform(typeText("harrison8896"))
//        onView(withId(R.id.input_password)).perform(pressImeActionButton())
//        onView(withId(R.id.loginButton)).perform(click()).perform(closeSoftKeyboard())
